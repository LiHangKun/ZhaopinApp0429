...
public class UploadRequestBuilder extends RequestBuilder {
    ...
    public Call start(OkHttpClient mHttpClient ,UploadListener uploadListener) {

        Builder multipartBuilder = new Builder().setType(MultipartBody.FORM);
    ...
    private static void addParams(Builder builder, Map<String, String> params) {
    ...
    private static void addFiles(Builder builder, Pair<String, File>... files) {
        if (files != null) {
