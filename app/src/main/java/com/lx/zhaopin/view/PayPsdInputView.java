...
public class PayPsdInputView extends AppCompatEditText {
    ...
    private void getAtt(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.PayPsdInputView1);
        maxCount = typedArray.getInt(R.styleable.PayPsdInputView1_maxCount1, maxCount);
        circleColor = typedArray.getColor(R.styleable.PayPsdInputView1_circleColor1, circleColor);
        bottomLineColor = typedArray.getColor(R.styleable.PayPsdInputView1_bottomLineColor1, bottomLineColor);
        radius = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputView1_radius1, radius);
        divideLineWidth = typedArray.getDimensionPixelSize(R.styleable.PayPsdInputView1_divideLineWidth1, divideLineWidth);
        divideLineColor = typedArray.getColor(R.styleable.PayPsdInputView1_divideLineColor1, divideLineColor);
        psdType = typedArray.getInt(R.styleable.PayPsdInputView1_psdType1, psdType);
        rectAngle = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputView1_rectAngle1, rectAngle);
        focusedColor = typedArray.getColor(R.styleable.PayPsdInputView1_focusedColor1, focusedColor);
