...
public class MyWebView extends RelativeLayout {
	...
	public MyWebView(Context context, AttributeSet attrs) {
		...
		// TODO Auto-generated constructor stub
		this.context = context;
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.WebViewWithProgress1);
        mProgressStyle = attributes.getInt(R.styleable.WebViewWithProgress1_progressStyle1, ProgressStyle.Horizontal.ordinal());
        mBarHeight = attributes.getDimensionPixelSize(R.styleable.WebViewWithProgress1_barHeight, DEFAULT_BAR_HEIGHT);
        attributes.recycle();
		init();
	}
