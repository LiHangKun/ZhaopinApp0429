...
public class ShouYe2Fragment extends Fragment {
    ...
    private static final String TAG = "ShouYe2Fragment";
    ...
    public void getEventmessage(MessageEvent event) {
        ...
        switch (messageType) {
            case 4:
                ...
                getDataList("3", "", SPTool.getSessionValue(AppSP.sStringJ), SPTool.getSessionValue(AppSP.sStringW), cityId, String.valueOf(nowPageIndex), AppSP.pageCount);
                break;
        }
    }
