...
public class MyApplication extends Application {
    ...
    public void onCreate() {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                SPTool.init(mContext, AppUtils.getAppName(mContext));
                // 主要是添加下面这句代码
                MultiDex.install(mContext); //65536
                ...
                //------TODO-------融云部分------
                RongIM.init(mContext, AppSP.RongToken);//融云
                ...
                UMConfigure.init(mContext, "5de708d1570df3243e000b63", "Umeng", UMConfigure.DEVICE_TYPE_PHONE, "");
                //三方登录
