...
public class AppSP {
    ...
    //public static final String RongToken = "8luwapkv84kil";//融云Token  测试
    public static final String RongToken = "8brlm7uf8que3";//融云Token   正式
    ...
    public static final String sex = "1";//  hrid
