...
public class HRDaiMianShi_In_ListAdapter extends RecyclerView.Adapter<HRDaiMianShi_In_ListAdapter.ViewHolder> {

    private List<HRDaiMianShiListBean.DataListBean.InterviewsBean> mData;
    private Context mContext;


    public HRDaiMianShi_In_ListAdapter() {
    }

    public HRDaiMianShi_In_ListAdapter(Context context, List<HRDaiMianShiListBean.DataListBean.InterviewsBean> allList) {
        mContext = context;
        mData = allList;
    }
