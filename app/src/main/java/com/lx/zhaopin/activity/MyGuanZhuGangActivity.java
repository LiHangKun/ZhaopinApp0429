...
import com.lx.zhaopin.adapter.MyGuanZhuAdapter;
...
public class MyGuanZhuGangActivity extends BaseActivity {
    ...
    private static final String TAG = "MyGuanZhuGangActivity";
    private List<GuanZhuGongSiBean.DataListBean> allList;
    ...
    private void init() {
        ...
        myGuanZhuAdapter = new MyGuanZhuAdapter(mContext, allList);
        recyclerView.setAdapter(myGuanZhuAdapter);

        myGuanZhuAdapter.SetOnItemClickListener(getOnItemClickListener());
    ...
    //取消关注公司
    private void quXiaoGuanZhuGongSi(String cid) {
    ...
    private void getDataList(String pageNo, String pageSize) {
        ...
        OkHttpHelper.getInstance().post(mContext, NetClass.BASE_URL + NetCuiMethod.guanzhuGongSi, params, new SpotsCallBack<GuanZhuGongSiBean>(mContext) {
            @Override
            public void onSuccess(Response response, GuanZhuGongSiBean resultBean) {
