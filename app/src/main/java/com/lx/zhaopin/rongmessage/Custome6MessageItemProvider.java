...
public class Custome6MessageItemProvider extends IContainerItemProvider.MessageProvider<Custome1Message> {

    private Context mContext;
    private static final String TAG = "Custome6MessageItemProvider";
