...
@ProviderTag(messageContent = Custome05Message.class, centerInHorizontal = true, showSummaryWithName = false)
public class Custome05MessageItemProvider extends IContainerItemProvider.MessageProvider<Custome05Message> {
    ...
    @Override
    public void bindView(View view, int i, final Custome05Message custome05Message, UIMessage uiMessage) {
        ...
        if (uiMessage.getMessageDirection() == Message.MessageDirection.SEND) {
            ...
            if (custome05Message.getContent() != null) {
                ...
                holder.tvTitle3.setText("您已取消面试");
            ...
            if (custome05Message.getContent() != null) {
                ...
                holder.llView4.setVisibility(View.GONE);
                holder.tvTitle2.setText("HR已取消您的面试,点击查看详情");


                final RongMessageInBean rongMessageInBean = gson.fromJson(custome05Message.getContent(), RongMessageInBean.class);
