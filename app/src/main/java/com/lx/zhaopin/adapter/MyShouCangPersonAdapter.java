...
public class MyShouCangPersonAdapter extends RecyclerView.Adapter<MyShouCangPersonAdapter.ViewHolder> {
    ...
    public MyShouCangPersonAdapter() {
    }

    public MyShouCangPersonAdapter(Context context, List<ShouCangZhiWeiBean.DataListBean> list) {
        mContext = context;
        mData = list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_shoucangperson_layout, viewGroup, false));
    }
