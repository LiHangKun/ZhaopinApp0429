...
public class SelectQiWang1Adapter extends RecyclerView.Adapter<SelectQiWang1Adapter.ViewHolder> {
    ...
    public SelectQiWang1Adapter() {
    }

    public SelectQiWang1Adapter(Context context, List<SelectQiWangBean.DataListBean> list) {
        mContext = context;
        mData = list;
    }
